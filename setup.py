...
# specify the packages that msl-digitech-camera depends on
install_requires = []
...
init_original = 'msl/digitech_camera/__init__.py'
init_backup = init_original + '.backup'
version = get_version()

setup(
    name='msl-digitech-camera',
    version=version,
    author=fetch_init('__author__'),
    author_email='info@measurement.govt.nz',
    url='https://github.com/MSLNZ/msl-digitech-camera',
    description='Write a short description about msl-digitech-camera here',
